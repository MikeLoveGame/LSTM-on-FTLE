...
for t in range(0, int(inttime / delta)):
    ...
    print
    'calculation time: ' + str(time.time() - start_time)
...
print
dir_str + ' FTLE field at t=' + str(t_start) + \
' has been calculated'
